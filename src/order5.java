...
public class order5 {
	...
	public void initialize() {
		...
		pho.setVisible(true);
		pho.setBounds(0, 0, 1368, 689);
		pho.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		pho.getContentPane().setLayout(null);
		...
		JLabel foodTwo = new JLabel("Noodle Soup");
		foodTwo.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodTwo.setBounds(10, 82, 219, 46);
		panel.add(foodTwo);

		JLabel foodThree = new JLabel("Jelly Fish");
		...
		pho.getContentPane().add(panel_4);
		...
		pho.getContentPane().add(panel_5);
