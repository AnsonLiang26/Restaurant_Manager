...
public class order1 {
	...
	public void initialize() {
		...
		// name
		frmMcdonalds = new JFrame();
		frmMcdonalds.setTitle("McDonald's");
		frmMcdonalds.setVisible(true);
		frmMcdonalds.setBounds(0, 0, 1368, 689);
		frmMcdonalds.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmMcdonalds.getContentPane().setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(10, 48, 425, 294);
		panel.setBorder(new LineBorder(new Color(0, 0, 0), 8));
		frmMcdonalds.getContentPane().add(panel);
		panel.setLayout(null);

		// food items
		JLabel foodOne = new JLabel("McChicken");
		foodOne.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodOne.setBounds(11, 10, 219, 46);
		panel.add(foodOne);

		JLabel foodTwo = new JLabel("BigMac");
		foodTwo.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodTwo.setBounds(10, 82, 219, 46);
		panel.add(foodTwo);

		JLabel foodThree = new JLabel("Cheese Burger");
		foodThree.setFont(new Font("Tahoma", Font.PLAIN, 30));
		...
		frmMcdonalds.getContentPane().add(panel_3);
		...
		frmMcdonalds.getContentPane().add(panel_4);
		...
		frmMcdonalds.getContentPane().add(panel_5);
		...
		frmMcdonalds.getContentPane().add(totalCalculate);
		...
		frmMcdonalds.getContentPane().add(receiptCalculate);
	}
