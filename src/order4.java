...
public class order4 {
	...
	public void initialize() {
		...
		// name
		burgerKing = new JFrame();
		burgerKing.setVisible(true);
		burgerKing.setTitle("Burger King");
		burgerKing.setBounds(0, 0, 1368, 689);
		burgerKing.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		burgerKing.getContentPane().setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(10, 48, 425, 294);
		panel.setBorder(new LineBorder(new Color(0, 0, 0), 8));
		burgerKing.getContentPane().add(panel);
		panel.setLayout(null);

		// food items
		JLabel foodOne = new JLabel("Bacon Cheeseburger");
		foodOne.setFont(new Font("Tahoma", Font.PLAIN, 23));
		foodOne.setBounds(11, 10, 219, 46);
		panel.add(foodOne);

		JLabel foodTwo = new JLabel("Whopper");
		foodTwo.setFont(new Font("Tahoma", Font.PLAIN, 23));
		foodTwo.setBounds(10, 82, 219, 46);
		panel.add(foodTwo);

		JLabel foodThree = new JLabel("Crispy Chicken Sandwich");
		foodThree.setFont(new Font("Tahoma", Font.PLAIN, 18));
		...
		burgerKing.getContentPane().add(panel_1);
		panel_1.setLayout(null);

		JLabel lblBaconCheeseburger = new JLabel("Bacon Cheeseburger $1.49");
		lblBaconCheeseburger.setBounds(10, 10, 318, 46);
		lblBaconCheeseburger.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblBaconCheeseburger);

		JLabel lblWhopper = new JLabel("Whopper $4.19");
		lblWhopper.setBounds(10, 51, 318, 46);
		lblWhopper.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblWhopper);

		JLabel lblCrispyChickenSandwich = new JLabel("Crispy Chicken Sandwich $4.99");
		lblCrispyChickenSandwich.setBounds(10, 94, 318, 46);
		lblCrispyChickenSandwich.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblCrispyChickenSandwich);

		JLabel lblSmallDrink = new JLabel("Small Drink $1.79");
		lblSmallDrink.setBounds(10, 135, 318, 46);
		lblSmallDrink.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblSmallDrink);

		JLabel lblMediumDrink = new JLabel("Medium Drink $2.09");
		lblMediumDrink.setBounds(10, 175, 318, 46);
		lblMediumDrink.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblMediumDrink);

		JLabel lblLargeDrink = new JLabel("Large Drink $2.39");
		...
		burgerKing.getContentPane().add(panel_3);
		...
		burgerKing.getContentPane().add(panel_4);
		...
		burgerKing.getContentPane().add(panel_5);
		...
		burgerKing.getContentPane().add(back);
		...
		burgerKing.getContentPane().add(receiptPrint);
		...
		burgerKing.getContentPane().add(totalCalculate);
		...
		receiptCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// printing receipt
				receipt.append("\nBacon Cheeseburger:\t\t" + Qty1 + "\nWhopper:\t\t" + Qty2 + "\nCrispy Chicken Sandwich:\t\t" + Qty3
						+ "\nSmall Drink:\t\t" + Qty4 + "\nMedium Drink:\t\t" + Qty5 + "\nLarge Drink:\t\t" + Qty6
						+ "\n\nThanks for ordering!");
		...
		burgerKing.getContentPane().add(receiptCalculate);
	}
