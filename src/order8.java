...
public class order8 {
	...
	public void initialize() {
		...
		taco.setBounds(0, 0, 1368, 689);
		taco.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		taco.getContentPane().setLayout(null);
		...
		JLabel foodTwo = new JLabel("Beef Soft Taco");
		foodTwo.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodTwo.setBounds(10, 82, 219, 46);
		panel.add(foodTwo);

		JLabel foodThree = new JLabel("Chicken Soft Taco");
		foodThree.setFont(new Font("Tahoma", Font.PLAIN, 27));
		...
		taco.getContentPane().add(panel_4);
		...
		taco.getContentPane().add(panel_5);
