...
public class order9 {
	...
	public void initialize() {
		...
		// name
		Pizza = new JFrame();
		Pizza.setTitle("Pizza Pizza");
		Pizza.setVisible(true);
		Pizza.setBounds(0, 0, 1368, 689);
		Pizza.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		Pizza.getContentPane().setLayout(null);
		...
		Pizza.getContentPane().add(panel_3);
		...
		Pizza.getContentPane().add(panel_4);
		...
		Pizza.getContentPane().add(receiptPrint);
		...
		Pizza.getContentPane().add(totalCalculate);
		...
		Pizza.getContentPane().add(receiptCalculate);
	}
