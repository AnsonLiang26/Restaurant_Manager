...
public class order2 {
	...
	public void initialize() {
		...
		//name
		Subway = new JFrame();
		Subway.setTitle("Subway");
		Subway.setVisible(true);
		Subway.setBounds(0, 0, 1368, 689);
		Subway.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		Subway.getContentPane().setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(10, 48, 425, 294);
		panel.setBorder(new LineBorder(new Color(0, 0, 0), 8));
		Subway.getContentPane().add(panel);
		panel.setLayout(null);

		// food items
		JLabel foodOne = new JLabel("6-inch Sub");
		foodOne.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodOne.setBounds(11, 10, 219, 46);
		panel.add(foodOne);

		JLabel foodTwo = new JLabel("Foot-Long Sub");
		foodTwo.setFont(new Font("Tahoma", Font.PLAIN, 30));
		foodTwo.setBounds(10, 82, 219, 46);
		panel.add(foodTwo);

		JLabel foodThree = new JLabel("Sub of the Day");
		...
		Subway.getContentPane().add(panel_1);
		panel_1.setLayout(null);

		JLabel lbl6InchSub = new JLabel("6-inch Sub $6.29");
		lbl6InchSub.setBounds(10, 10, 318, 46);
		lbl6InchSub.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lbl6InchSub);

		JLabel lblFootLongSub = new JLabel("Foot-Long Sub $9.49");
		lblFootLongSub.setBounds(10, 51, 318, 46);
		lblFootLongSub.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblFootLongSub);

		JLabel lblSubOfTheDay = new JLabel("Sub of the Day $3.99");
		lblSubOfTheDay.setBounds(10, 94, 318, 46);
		lblSubOfTheDay.setFont(new Font("Tahoma", Font.PLAIN, 30));
		panel_1.add(lblSubOfTheDay);
		...
		Subway.getContentPane().add(panel_3);
		...
		Subway.getContentPane().add(panel_4);
		...
		Subway.getContentPane().add(panel_5);
		...
		Subway.getContentPane().add(back);
		...
		Subway.getContentPane().add(receiptPrint);
		...
		Subway.getContentPane().add(totalCalculate);
		...
		Subway.getContentPane().add(receiptCalculate);
	}
